package com.ingcore.common.generate;
...
import com.ingcore.common.utils.FileUtils;
import com.ingcore.common.utils.FreeMarkers;
import com.ingcore.common.utils.StringUtilsEx;
...
public class MakeDBPersistence {
    ...
    private static final String URL = "jdbc:mysql://101.201.210.244:3306/mplus?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&autoReconnect=true&failOverReadOnly=false&maxReconnects=10&allowMultiQueries=true";
    

    private static final String USERNAME = "root";
    private static final String PASSWORD = "12332837284787487QQKJKJDKHIHBNMSMFLSKF_LSKJLdkfjlajf900202010103kkdkfjakjkf";
    ...
    private static String FTL_DIR = "D:\\work\\remoteDesk\\ingcore_new\\ingcore_common\\src\\main\\java\\com\\ingcore\\algorithm\\generate";
	...
	private static void makeInterface(DatabaseMetaData metadata, String catalog) {
		...
		try {
			...
			// 模板文件路径
			String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/ingcore/algorithm/generate/template", "/", separator);
