...
public class BeanUtilsEx {
    ...
    private static void printObject(Object object, String tabString) throws Exception
    {
        ...
        {
            if (object instanceof java.util.Map<?, ?> || object instanceof java.util.List<?> || (isHasChildProperty(object.getClass()) && !object.getClass().isEnum()))
            {
        ...
        if (object instanceof java.util.Map<?, ?>)
        {
            ...
            for (String key : ((Map<String, Object>) object).keySet())
            {
                ...
                else
                {
                    ...
                    if (mapObject instanceof java.util.Map<?, ?> || mapObject instanceof java.util.List<?> || (isHasChildProperty(mapObject.getClass()) && !mapObject.getClass().isEnum()))
                    {
        ...
        for (PropertyDescriptor propertyDescriptor : propertieDescritors)
        {
            ...
            // 如果目标是一个List 对象
            {
                ...
                //				else
                {
                    ...
                    if (objValue instanceof java.util.Map<?, ?> || objValue instanceof java.util.List<?> || (isHasChildProperty(objValue.getClass()) && !objValue.getClass().isEnum()))
                    {
    ...
    private static Map<String, Object> getObjectMap(String nameString, Map<String, Object> parentMap)
    {
        ...
        else
        {
            ...
            if (parentMap.get(names[0]) != null && parentMap.get(names[0]) instanceof java.util.Map<?, ?>)
            {
    ...
    public static Object getObjectByName(String name, Object object,String [] fieldList) throws Exception
    {
        ...
        if (object instanceof java.util.Map<?, ?>)
        {
            return ((java.util.Map<String, Object>) object).get(name);
        }
        ...
        if (names.length <= 1)
        {
            ...
            {
                if (toReturnObject instanceof java.util.List<?>&&fieldList!=null&&fieldList.length>0)
                {
        ...
        {
            if (toReturnObject instanceof java.util.List<?>)
            {
