...
import com.ingcore.common.utils.secure.CommonProperty;
...
///		 PropertiesUtil.getParamInProp("algorithm.properties","key");
		 secret= commonProperty.getPropertyForStr("secret");
/// PropertiesUtil.getParamInProp("algorithm.properties","secret");
		 bucket= commonProperty.getPropertyForStr("bucket");
///		 PropertiesUtil.getParamInProp("algorithm.properties","bucket");
		 endpoint= commonProperty.getPropertyForStr("endpoint");
///		 PropertiesUtil.getParamInProp("algorithm.properties","endpoint");
		 bucketApp= commonProperty.getPropertyForStr("bucket-app");
///		 PropertiesUtil.getParamInProp("algorithm.properties","bucket-app");
		 endpointApp= commonProperty.getPropertyForStr("endpoint-app");
///		 PropertiesUtil.getParamInProp("algorithm.properties","endpoint-app");
