...
public class VoucherConstants {
     ...
     * 不限影片
     */
    public static final int VOUCHER_FILM_CHOOSE_WAY_NOLIMIT = 1;
    /**
     * 全部影片
     */
    public static final int VOUCHER_FILM_CHOOSE_WAY_ALL = 2;
    /**
     * 指定影片
     */
    public static final int VOUCHER_FILM_CHOOSE_WAY_SPECIFIED = 3;
    /**
     * 不限卖品
     */
