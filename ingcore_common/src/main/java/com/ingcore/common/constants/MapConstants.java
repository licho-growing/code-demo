...
public class MapConstants {
    ...
    private static void initRefundChannel(){
        refundChannel.put(1,"app退");
        refundChannel.put(2,"订单失败自动退");
        refundChannel.put(3,"B端手动退");
    }
    ...
    private static void initOrderChannel(){
        orderChannel.put(0,"app");
        orderChannel.put(1,"微站");
        orderChannel.put(2,"轻量化");
        orderChannel.put(3,"pc端购票");
        orderChannel.put(4,"渠道卡");
        orderChannel.put(5,"0元");
    }
}
